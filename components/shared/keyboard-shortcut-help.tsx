...
const sessionShortcuts = [
  ...
  { keys: "⌘+Enter", action: "Add new discovery item after current" },
  { keys: "↑ / ↓", action: "Navigate between sub-items" },
  { keys: "⌘+D", action: "Toggle resolved (strikethrough)" },
  { keys: "⌘+B", action: "Toggle important (bold)" },
  { keys: "⌘+Backspace", action: "Delete sub-item" },
  { keys: "⌘+Shift+F", action: "Quick-add follow-up" },
  { keys: "Alt+1..4", action: "Jump to sub-item type" },
